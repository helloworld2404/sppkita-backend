...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="mt-1 mb-1">
                <!-- Export button to trigger PDF generation -->
                <a href="{{ route('pembayaran_siswa.create') }}" class="btn btn-danger btn-sm">Eksport</a>
            </div>

            <!-- Filter form -->
            <form action="{{ route('pembayaran_siswa.index') }}" method="GET" class="mb-3">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="text" class="form-control" id="bulan" name="bulan" placeholder="Masukkan bulan">
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{ $pembayaran->firstItem() + $no }}</th>
                                <td>{{ $p->siswa->nama }}</td>
